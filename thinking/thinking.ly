...
melody = \relative ges, {
  ...
  aes16)(
     \cadenzaOn \hideNotes aes) \unHideNotes \cadenzaOff 
     ces'?-^ r8 r16[ e,, a \deadNote e] 
     bes'(\cadenzaOn \hideNotes aes) \unHideNotes \cadenzaOff 
     des'?-^ r8 r16[ d, des c ]
  ...
  r8.[ ees'16] r16[ \deadNote ees, ees16 r] r[ ees'16 r ees,] r[ a, r aes]
  r16 aes' aes, aes r[ \deadNote aes a8] bes8. bes16 r[ \deadNote d des c]
  r16[ g' r c] r8[ g16 \deadNote ges] f c aes f(f4) \glissando \hideNotes c' \unHideNotes
  r2. r8. aes16-^-.
  \bar "|."
